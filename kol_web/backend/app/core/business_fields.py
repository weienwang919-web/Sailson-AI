...
BUSINESS_FIELDS: tuple[BusinessField, ...] = (
    ...
    BusinessField("language", "语言/Language", "core", ("filter", "detail", "export", "create", "update")),
    ...
    BusinessField("notes", "备注/Notes", "progress", ("list", "filter", "detail", "export", "create", "update")),
